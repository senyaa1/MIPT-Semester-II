...
## Тестовая машина
 - `12th Gen Intel(R) Core(TM) i7-12700H` (с поддержкой `avx2`)
  - PState отключен, частота - $4.6$ ГГц 
...
<table>
  <tr>
    <td align="center"><img src="pics/perf1.png"  width="100%" alt="perf 1"><p> Рис. 5. Отчет профилировщика</p></td>
  </tr>
</table>
...
$\sigma = \frac{\sqrt{\frac{1}{N-1} \sum_{i=1}^N \bigl(x_i - \bar x\bigr)^2}}{\sqrt{N}}$
 ...
 - Наивная реализация (среднее):    $1.199 \pm 0.110$ s

Оптимизированная версия получилась в $3.06 \pm 0.28$ раза быстрее чем исходная реализация.

**КПД:** $\alpha = \frac{\text{коэф. ускорения}}{\text{кол-во строк asm-кода}} = \frac{3.06}{19} \approx 0.16$.
